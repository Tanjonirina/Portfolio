...
() {
  ...
  return (
    <section id='competence' className='bg-gradient-to-b from-gray-700 to-black text-white'>
    <div className='text-center  w-full h-full '>
        <h3 className='text-4xl font-semibold '>Com<span className='text-orange-400'>pétence</span> </h3>
        
    </div>
    <br/>

    <div  className=' w-full grid grid-cols-2 sm:grid-cols-3 gap-8 px-12 sm:px-0 sm:'>
                {
                  Experience.map(({id, src,title,style})=>{
                    return(
                    
                              <div key={id} className = {`shadow-md shadow-gray-600 rounded-lg ${style}`} >
                                <img src={src} className='rounded-md duration-200 hover:scale-105 w-20 mx-auto' ></img>
